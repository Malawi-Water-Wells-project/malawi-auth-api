...
class WellHygiene(db.Model):
    ...
    village = db.Column(db.String(10), unique=True, index=True)
    ...
    electrical_conductivity_dry = db.Column(db.Float, nullable=True, index=True)
    electrical_conductivity_wet = db.Column(db.Float, nullable=True, index=True)
    ...
    nitrateno2_dry = db.Column(db.Float, nullable=True, index=True)
